...
const ROLE_ASSIGNMENT_OPTIONS: Array<{
...
}> = [
  {
    value: "super_admin",
    label: "超级管理员",
    description: "最高权限，统筹全局配置、角色分配、模型策略与关键安全操作。",
    permissionHint: "包含全量后台权限、高危治理能力，并可使用全部高级模型。",
  },
  {
    value: "operator",
    label: "运营人员",
    description: "负责用户治理、内容运营、模板巡检与日常后台协同。",
    permissionHint: "包含用户管理、内容审核、数据查看，并可使用高级模型。",
  },
  {
    value: "finance",
    label: "财务人员",
    description: "负责台账核对、充值补偿、资产导出与财务复盘。",
    permissionHint: "包含财务报表、Token 流水、充值记录与导出，并可使用高级模型。",
  },
  {
    value: "user",
    label: "普通用户",
    description: "标准业务账号，仅保留前台创作能力，不具备后台管理权限。",
    permissionHint: "仅保留前台创作与个人资料能力，不可使用受限高级模型。",
  },
  {
    value: "admin",
    label: "平台管理员",
    description: "平台治理角色，适合全局运营协同、账号治理与高级能力测试。",
    permissionHint: "拥有管理团队级权限、无限额度展示，并可使用高级模型。",
  },
  {
    value: "premium",
    label: "高级用户",
    description: "会员型高阶业务账号，保留前台高级权益，但不开放后台治理能力。",
    permissionHint: "可使用高级模型与会员侧业务能力，不开放后台管理权限。",
  },
];
